...
const quizData: Question[] = [
  {
    ...
    rationale: "According to guidelines (How to Manage My Account, Page 5), customers can add a maximum of 10 extensions per cycle. The 11th request should be rejected."
  },
  {
    ...
    rationale: "High-end routers cost 57 EGP monthly for 30 months (related vas & offers, Page 23)."
  },
  {
    ...
    rationale: "If calling from a registered mobile number, the agent only needs to ask for the DSL subscriber name (How to Manage My Account, Page 7)."
  },
  {
    ...
    answer: "7 days",
    rationale: "The grace period is 7 days from the bill issuance date (Billing after update, Page 7)."
  },
  {
    ...
    answer: "2 days",
    rationale: "Promise to Pay restores service for 2 days only and must be requested within 5 days of disconnection (Billing after update, Page 8)."
  },
  {
    ...
    rationale: "Standard downgrades are always implemented starting from the next bill cycle (How to Manage My Account, Page 22)."
  },
  {
    ...
    answer: "8 SMS",
    rationale: "Customers receive 8 dunning notifications from the bill issuance date until the 5th day after suspension (Billing after update, Page 7)."
  },
  {
    ...
    answer: "226.86 EGP",
    rationale: "New customers must pay 12 bills; otherwise, a violation fee of 226.86 EGP applies (related vas & offers, Page 15)."
  },
  {
    question: "An extension (Extra Quota) was added today. How long is its validity?",
    image: q1, // استخدمنا q1 كصورة افتراضية هنا
    options: ["15 days", "30 days", "Until the end of the current cycle", "1 year"],
    answer: "30 days",
    rationale: "Extension validity is 30 days from the addition date (related vas & offers, Page 13)."
  },
  {
    ...
    rationale: "Upgrade SLA for a ready cabinet is 1 working day (related vas & offers, Page 8)."
  },
  {
    ...
    rationale: "Free GBs provided as an upselling offer are valid for 1 month (related vas & offers, Page 7)."
  },
  {
    ...
    answer: "48 Hours",
    rationale: "Extension Offer Adjustment (Short code 5048) has an SLA of 48 working hours."
  }
];
