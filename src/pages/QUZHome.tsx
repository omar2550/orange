      ...
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-2xl overflow-hidden">
        {showScore ? (
          <div className="p-10 text-center">
            ...
            <p className="text-slate-500 mb-8 text-lg">Great effort! Keep reviewing the guidelines to stay sharp.</p>
            <button
            ...
            <div className="p-6 sm:p-8">
                ...
                {quizData[currentQuestion].options.map((option, idx) => (
                  <button
                    ...
                    className={`p-4 text-left rounded-xl border-2 transition-all duration-200 text-sm font-medium
                      ...
                      ${selectedOption !== null && option === quizData[currentQuestion].answer ? 'border-green-500 bg-green-50 text-green-700 opacity-100' : ''}
                    `}
                  >
              ...
              {selectedOption && (
                ...
                `}>
                  ...
                  <button
                    onClick={handleNext}
                    className="mt-4 w-full py-3 bg-slate-800 text-white font-bold rounded-lg hover:bg-slate-900 transition-shadow shadow-md"
                  >
                    Next Question
                  </button>
                </div>
